...
RES4LYF / samplers / ClownOptions SDE Beta
RES4LYF / samplers / SharkOptions Beta
```
...
* **Do not install this package alongside the full RES4LYF pack.** Both register nodes under the same class names and will conflict. This package is strictly for users who want only the ClownSampler\_Beta node without having to install requirements that might break their ComfyUI Python environment.
