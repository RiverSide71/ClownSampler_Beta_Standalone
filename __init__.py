...
try:
    ...
    from .beta.samplers_extensions import ClownOptions_SDE_Beta, SharkOptions_Beta
    _import_ok = True
...
NODE_CLASS_MAPPINGS = {
    ...
    "ClownOptions_SDE_Beta":     ClownOptions_SDE_Beta,
    "SharkOptions_Beta":         SharkOptions_Beta,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "ClownSampler_Beta":         "ClownSampler Beta",
    "ClownSamplerAdvanced_Beta": "ClownSampler Advanced Beta",
    "ClownOptions_SDE_Beta":     "ClownOptions SDE Beta",
    "SharkOptions_Beta":         "SharkOptions Beta",
}
