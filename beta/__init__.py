...
def add_beta(NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS, extra_samplers_dict):
...
def extra_samplers():
    ...
    extra_samplers_dict.update(extra_samplers())
    return NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS, extra_samplers_dict
